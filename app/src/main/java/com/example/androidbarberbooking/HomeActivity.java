...
import com.example.androidbarberbooking.Fragment.HomeFragment;
import com.example.androidbarberbooking.Fragment.ShoppingFragment;
...
public class HomeActivity extends AppCompatActivity {
                                ...
                                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        if(!userSnapshot.exists()){
                                            showUpdateDiaglog(account.getPhoneNumber().toString());
                                        }
                                        else {
    ...
    private void showUpdateDiaglog(final String phoneNumber) {
        if (dialog.isShowing()){
            dialog.dismiss();
        }
